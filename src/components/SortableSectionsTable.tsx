...
function SortableRow({
  section, saving, onTierChange, onAdminOnlyChange, onLockChange, tierColor,
}: {
  section: SectionRow;
  saving: string | null;
...
export default function SortableSectionsTable({ sections, saving, onReorder, onTierChange, onAdminOnlyChange, onLockChange, tierColor }: Props) {
