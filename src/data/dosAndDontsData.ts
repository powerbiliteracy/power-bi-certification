...
export const DOS_DONTS_DOMAINS: DosDontsDomain[] = [
  ...
  },
  {
    ...
    subtopics: [
      ...
      {
        id: "3.2", title: "Enhance Reports for Usability",
        bullets: ["Bookmarks", "Tooltips", "Sync slicers", "Accessibility"],
        dos: [
          ...
          { text: "Set tab order for keyboard navigation.", reason: "Users who rely on keyboard navigation need logical tab order." },
        ],
        donts: [
    ...
    subtopics: [
      {
        ...
        bullets: ["Workspace roles", "Apps and sharing", "Refresh configuration", "Deployment pipelines"],
        dos: [
          ...
          { text: "Publish workspace apps for end-user consumption.", reason: "Apps provide a curated, read-only experience appropriate for consumers." },
      ...
      {
        id: "4.2", title: "Security and Governance",
        bullets: ["Row-Level Security", "Object-Level Security", "Sensitivity labels", "Governance"],
        dos: [
          ...
          { text: "Apply sensitivity labels to classify content appropriately.", reason: "Labels persist on exports, enforcing data protection beyond Power BI." },
