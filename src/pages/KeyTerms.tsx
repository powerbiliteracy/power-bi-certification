    ...
    sections: [
      ...
      },
      {
        ...
        terms: [
          ...
          { term: "Copilot content suggestions", def: "Copilot proposes visuals, fields, and layouts for a new report page.", speed: "Insert → Copilot → Suggest content.", tip: "Use 'Suggest content for a new page' to bootstrap a draft, then refine.", practice: "Generate a starter Sales overview page with Copilot, then tighten manually." },
      ...
      },
      {
        ...
        terms: [
          ...
          { term: "Export settings", def: "Workspace/tenant settings controlling whether users can export to Excel, CSV, PDF, or underlying data.", speed: "File → Options → Report settings. Tenant admin can lock down.", tip: "Block 'Export underlying data' for sensitive reports — it bypasses report filters.", practice: "Disable underlying-data export on RLS-protected reports." },
          { term: "Personalized visuals", def: "Lets consumers swap fields, change visual type, and save personal views without altering the source.", speed: "Format → Report settings → Personalize visuals.", tip: "Personalisations save per user as bookmarks — published report stays clean.", practice: "Enable on exploratory reports so analysts can self-serve." },
        ]
      },
      {
